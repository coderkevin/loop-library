...
import { createAddClipToSetHandler } from './addClipToSet';
import { createMockReq, createMockRes } from '../testUtils/mockReqRes';

describe('addClipToSetHandler', () => {
  it('400 when missing fields', async () => {
    const handler = createAddClipToSetHandler({
  ...
  it('adds clip id and persists', async () => {
